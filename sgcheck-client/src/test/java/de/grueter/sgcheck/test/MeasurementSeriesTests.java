...
public class MeasurementSeriesTests {
	...
	public void testCreateMeasurementSeries1() throws Exception {
		lastMeasurementSeriesId = MeasurementSeriesModel.getInstance().createMeasurementSeries("Toaster", new Measurand(1, "Spannung", "V"), 0);
	}
	
	@Test(expectedExceptions= {Exception.class})
	public void testCreateMeasurementSeries2() throws Exception {
		lastMeasurementSeriesId = MeasurementSeriesModel.getInstance().createMeasurementSeries("Toaster", new Measurand(1, "Spannung", "V"), -1);
	}
