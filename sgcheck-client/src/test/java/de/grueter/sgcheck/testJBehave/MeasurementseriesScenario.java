...
public class MeasurementseriesScenario extends JUnitStory {
	@Override
	...
	public List<CandidateSteps> candidateSteps() {
		return new InstanceStepsFactory(configuration(), new MeasurementseriesScenarioSteps()).createCandidateSteps();
	}
}
